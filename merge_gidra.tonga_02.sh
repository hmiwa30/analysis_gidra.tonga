...
#index
/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/results/output_chr${SGE_TASK_ID}/0000.vcf.gz;echo "index 0000 chr${SGE_TASK_ID} done"
/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/results/output_chr${SGE_TASK_ID}/0001.vcf.gz;echo "index 0001 chr${SGE_TASK_ID} done"
#isec jomon
...
#index jomon
/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/results/output_jomon_chr${SGE_TASK_ID}/0000.vcf.gz;echo "index 0000 chr${SGE_TASK_ID} done"
/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/results/output_jomon_chr${SGE_TASK_ID}/0001.vcf.gz;echo "index 0001 chr${SGE_TASK_ID} done"
/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/results/output_jomon_chr${SGE_TASK_ID}/0002.vcf.gz;echo "index 0002 chr${SGE_TASK_ID} done"
#pass
