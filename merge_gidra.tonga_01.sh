...
#index
#/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/data/gidra.tonga.gtonly.vcf.gz;echo "index done: `date`"
#/lustre7/home/hmiwa-spc/bcftools/bcftools index ~/hmiwa/analysis_gidra.tonga/data/gidra.tonga.gtonly.sedchr.cleaned.vcf.gz;echo "index done: `date`"
echo "finish: `date`"
